...
/**
 * Created by tina on 24/01/2017.
 */

public class BooksProvider extends ContentProvider {
    static final String PROVIDER_NAME =
            "com.example.tina.databases.contprov";
    ...
    static final int BOOK_BL = 3;
    static final int BOOK_ISBN = 4;
    ...
    static {
        ...
        uriMatcher.addURI(PROVIDER_NAME, "books/bl", BOOK_BL);
        uriMatcher.addURI(PROVIDER_NAME, "books/#", BOOK_ISBN);
    ...
    public int delete(Uri arg0, String arg1, String[] arg2) {
        ...
        switch (uriMatcher.match(arg0)){
            ...
            case BOOK_ID:
                ...
                break;
            case BOOK_ISBN:
                String isbn = arg0.getPathSegments().get(1);
                count = booksDB.delete(
                        DATABASE_TABLE,
                        ISBN + " = " + isbn +
                                (!TextUtils.isEmpty(arg1) ? " AND (" +
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        if (uriMatcher.match(uri) == BOOK_BL) {
            sqlBuilder.appendWhere(TITLE + " LIKE " + "'B%' OR ");
            sqlBuilder.appendWhere(TITLE + " LIKE " + "'L%' ");
        }
