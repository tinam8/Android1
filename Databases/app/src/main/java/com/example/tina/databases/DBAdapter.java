...
public class DBAdapter {
    ...
    static final String DATABASE_TABLE2 = "addresses";
    ...
    static final String DATABASE_CREATE2 =
            "create table addresses (_id integer primary key autoincrement, "
                    + "street text not null, number int not null);";
    ...
    public long insertAddress(String street, int number)
    {
        ContentValues initialValues = new ContentValues();
    ...
    {
        return db.query(DATABASE_TABLE2, new String[] {KEY_ROWID, KEY_STREET,
